    ...
    public class GamesController : BaseApiController
    {
        ...
        public IHttpActionResult Play(PlayRequestDataModel request)
        {
            ...
            switch (gameResult)
            {
                ...
                case GameResult.WonByX:
                    ...
                    this.data.Users.Find(currentUserId).GamesWon += 1;
                    this.data.SaveChanges();
                    break;
        ...
        public IHttpActionResult History()
        {
            ...
            var games = this.data.Games.All()
                ...
                {
                    Board = g.Board,
                    PlayerX = g.FirstPlayer.UserName,
                    PlayerO = g.SecondPlayer.UserName,
                    WonBy = g.State == GameState.WonByX ? g.FirstPlayer.UserName 
                    : g.State == GameState.WonByO ? g.SecondPlayer.UserName 
                    : "Draw"
                });
            return Ok(games);
        }
